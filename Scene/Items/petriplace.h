...
private:
    QString m_label{""};      ///< Текстовая метка позиции
    int m_tokens{0};          ///< Количество фишек в позиции
    bool m_queueMode{false};  ///< Флаг режима очереди (отображает разделительную линию)
